...
function renderSlateNode(node: any, key: string | number): React.ReactNode {
  ...
  if (node.text !== undefined) {
    ...
    if (node.code) el = <code className="bg-gray-100 rounded px-1 py-0.5 text-[#0a0d53] text-[13px]">{el}</code>;
  ...
  switch (type) {
    case 'h1':
      return <h1 key={key} className="text-[#0a0d53] font-roboto font-bold text-[26px] sm:text-[32px] lg:text-[36px] mt-12 mb-6">{renderedChildren}</h1>;
    case 'h2':
      return <h2 key={key} className="text-[#0a0d53] font-roboto font-bold text-[22px] sm:text-[26px] lg:text-[30px] mt-10 mb-5">{renderedChildren}</h2>;
    case 'h3':
      return <h3 key={key} className="text-[#0a0d53] font-roboto font-bold text-[18px] sm:text-[20px] mt-8 mb-4">{renderedChildren}</h3>;
    case 'h4':
    case 'h5':
    case 'h6':
      return <h4 key={key} className="text-[#0a0d53] font-roboto font-bold text-[16px] sm:text-[18px] mt-6 mb-3">{renderedChildren}</h4>;
    case 'ul':
      return <ul key={key} className="list-disc list-inside space-y-2 mb-6 text-[#5b6472] font-inter text-[14px] sm:text-[15px] leading-[1.8]">{renderedChildren}</ul>;
    case 'ol':
      return <ol key={key} className="list-decimal list-inside space-y-2 mb-6 text-[#5b6472] font-inter text-[14px] sm:text-[15px] leading-[1.8]">{renderedChildren}</ol>;
    case 'li':
    ...
    default:
      // Fallback for paragraph and unknown blocks
      return <p key={key} className="text-[#5b6472] font-inter text-[14px] sm:text-[15px] leading-[1.8] mb-4">{renderedChildren}</p>;
  }
}
